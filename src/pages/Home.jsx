                            ...
                            {displayItems.map((item, index) => (
                                item.type === 'mess' ? (
                                    ...
                                    <motion.a
                                        ...
                                        href={`tel:${item.phone}`}
                                        whileHover={{ y: -5 }}
                                        className="block p-6 rounded-2xl bg-white border border-gray-100 shadow-xl hover:shadow-2xl transition-all duration-300 group h-full flex flex-col justify-between"
                                    >
                                        <div>
